---
name: cpv-migrate-marketplace-architecture
description: >
  ...
  Use when migrating marketplace architecture. Used dynamically via cpv-the-skills-menu (TRDD-478d9687).
tags:
  - marketplace
  - migration
  - architecture
...
- Sibling: `cpv-setup-marketplace-auto-notification`
