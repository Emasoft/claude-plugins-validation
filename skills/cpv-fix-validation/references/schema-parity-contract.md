...
| 2026-04-18 | Follow-up hardening — cpv-plugin-creator-agent step-3 now delegates to cpv-plugin-fixer-agent; heuristic table added to `plugin-structure-fixes.md`; regression guards added to test suite | Workflow + docs + tests | v2.22.5 |
