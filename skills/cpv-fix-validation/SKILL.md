...
description: >
  ...
  are handled by cpv-migrate-marketplace-architecture. Used dynamically via cpv-the-skills-menu (TRDD-478d9687).
...
Fix log → `$MAIN_ROOT/reports/cpv-plugin-fixer-agent/<ts±tz>-<slug>.md`.
...
- Migration only: the repo-root `references/canonical-pipeline-migration-checklist.md` (CPV ships it under `references/`, NOT inside this skill dir) — 87-check exit gate.
