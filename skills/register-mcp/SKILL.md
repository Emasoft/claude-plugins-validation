...
register-mcp /path/to/my-plugin todo "node ${CLAUDE_PLUGIN_ROOT}/servers/todo/index.js"

# Python MCP server (stdio)
register-mcp /path/to/my-plugin db "uv run --with sqlite3 python ${CLAUDE_PLUGIN_ROOT}/servers/db/server.py"
