...
**Only WARNING / INFO / PASSED pass through (exit code 0).** CRITICAL, MAJOR,
MINOR, and NIT (in `--strict`) map to exit codes 1-4 and block. There is no
exit code 5 — WARNING and below never set a non-zero exit code.
