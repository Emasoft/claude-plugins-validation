...
description: Routes the /cpv-main-menu numbered-table menu. Used dynamically via skills-index (TRDD-478d9687) — primarily by cpv-main-menu-agent. Use when navigating CPV's many commands via a single entry point.
