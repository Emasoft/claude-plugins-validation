---
name: cpv-marketplace-authoring-contract
description: >
  Proactive marketplace.json authoring contract for plugin-touching agents. Use
  when drafting, modifying, or migrating any marketplace.json. Used dynamically via cpv-the-skills-menu (TRDD-478d9687).
when_to_use: >
...
Input: cpv-plugin-creator-agent scaffolds for `github.com/owner/foo-plugin`.
...
Input: cpv-plugin-fixer-agent addresses PIT-002 stale-version. Output: version DROPPED. Finding clears.
...
- Sibling: `skills/cpv-migrate-marketplace-architecture/`
- Sibling: `skills/cpv-fix-marketplace-validation/`
