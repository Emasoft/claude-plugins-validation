...
description: >
  ...
  Used dynamically via cpv-the-skills-menu (TRDD-478d9687).
tags:
  - marketplace
  - publish
  - ci-cd
...
4. **Verify CI**: `ci.yml` consolidated (lint + validate + test) per `cpv-canonical-pipeline`
...
- `cpv-canonical-pipeline` skill — publish.py, pre-push hook, CI workflows
