...
when_to_use: When the cpv-main-menu user picks Manage → Refresh README, or any flow needs to re-render the `<!-- BEGIN AUTO-COMPONENTS -->` block from current filesystem state
