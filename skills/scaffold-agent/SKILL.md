---
name: scaffold-agent
description: Scaffold a new agent in an existing plugin (creates agents/{NAME}.md with valid frontmatter that passes validate_plugin out of the box). Use when adding a single agent to an existing plugin. Loaded by cpv-main-menu-agent.
