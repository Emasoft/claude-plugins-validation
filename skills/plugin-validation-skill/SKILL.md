...
description: Validates Claude Code plugins for structural correctness, quality, and marketplace readiness. Use when validating, fixing, migrating, upgrading, or scaffolding a plugin. Used dynamically via the-skills-menu (TRDD-478d9687). Embeds canonical plugins-reference.md.
