...
`strip-dev-submodules` shrinks every CPV-style plugin install by moving
...
ship to end users. This skill generalises the pattern to N submodules
per plugin.
...
This skill performs DESTRUCTIVE operations (creates GitHub repos,
