---
name: cpv-semantic-validation-skill
description: "Deep AI semantic validation for skills/agents. Use when checking triggering, clarity, examples. Used dynamically via cpv-the-skills-menu (TRDD-478d9687). 10x token cost."
tags:
  - validation
  - semantic
  - quality
...
- Full criteria/rubrics/format: `skills/cpv-fix-validation/references/skill-semantic-validation.md`. Cheap counterparts: `cpv-skill-validation-skill`, `cpv-plugin-validation-skill`.
...
- [ ] Review A-F grade
- [ ] Report to `$MAIN_ROOT/reports/cpv-semantic-validator-agent/`
