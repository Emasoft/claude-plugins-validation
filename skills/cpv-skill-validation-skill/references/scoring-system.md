...
| **Semantic Grade** | A-F letter grade | AI agent (`cpv-semantic-validator-agent`, opus) | Description effectiveness, instruction clarity, example quality, workflow completeness |
