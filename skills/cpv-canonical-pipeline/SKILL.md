---
name: cpv-canonical-pipeline
description: >
  Standard files, CI/CD, hooks, and release pipeline for Emasoft Claude Code plugins.
  Use when creating or auditing plugin repos. Used dynamically via cpv-the-skills-menu — any CPV agent can invoke at runtime (TRDD-478d9687).
