...
- [Scaffolded plugins (created via `cpv-create-plugin` / `cpv-setup-plugin-repo`)](#scaffolded-plugins-created-via-create-plugin--setup-plugin-repo)
...
## Scaffolded plugins (created via `cpv-create-plugin` / `cpv-setup-plugin-repo`)
...
cpv-plugin-fixer-agent agents from a single main-session message) survives the
