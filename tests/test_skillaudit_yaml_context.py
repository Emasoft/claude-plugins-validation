...
class TestWorkflowSafeInstall:
    def test_apt_get_install(self) -> None:
        ...
        verdict = ctx.classify(
            ".github/workflows/ci.yml", src, line_idx, "sudo apt-get install", "PRIVILEGE_ESC"
        )
    ...
    def test_dnf_install(self) -> None:
        ...
        verdict = ctx.classify(
            ".github/workflows/ci.yml", src, line_idx, "sudo dnf install", "PRIVILEGE_ESC"
        )
        assert verdict == "code_fence_neutral"
    ...
    def test_brew_install(self) -> None:
        ...
        verdict = ctx.classify(
            ".github/workflows/ci.yml", src, line_idx, "brew install", "CMD_INJECTION"
        )
        assert verdict == "code_fence_neutral"
    ...
    def test_systemctl_restart(self) -> None:
        ...
        verdict = ctx.classify(
            ".github/workflows/deploy.yml", src, line_idx, "sudo systemctl restart", "PRIVILEGE_ESC"
        )
        assert verdict == "code_fence_neutral"
    ...
    def test_snap_install(self) -> None:
        ...
        verdict = ctx.classify(
            ".github/workflows/ci.yml", src, line_idx, "sudo snap install", "PRIVILEGE_ESC"
        )
        assert verdict == "code_fence_neutral"
...
class TestWorkflowSuspect:
    def test_curl_pipe_bash_is_unknown(self) -> None:
        ...
        verdict = ctx.classify(
            ".github/workflows/ci.yml", src, line_idx, "curl https", "CURL_PIPE_BASH"
        )
    ...
    def test_echo_secret_pipe_base64_is_unknown(self) -> None:
        ...
        verdict = ctx.classify(
            ".github/workflows/ci.yml", src, line_idx, "echo $SECRET", "DATA_EXFIL"
        )
        assert verdict == "unknown"
    ...
    def test_rm_rf_root_is_unknown(self) -> None:
        ...
        verdict = ctx.classify(
            ".github/workflows/ci.yml", src, line_idx, "rm -rf /", "DESTRUCTIVE_FS"
        )
        assert verdict == "unknown"
