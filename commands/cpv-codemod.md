...
argument-hint: "<subcommand> --plugin <path> [--apply] [--min-lines N]"
user-invocable: true
---

# /cpv-codemod — Deterministic Mechanical Fixes
...
- `/cpv-validate-plugin <path>` — find what to fix (read-only)
- `/cpv-fix-validation <report>` — agent-driven fixes for findings that
  require judgment
