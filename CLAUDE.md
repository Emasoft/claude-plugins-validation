...
|---|---|---|
| **version** | `2.152.0` | `.claude-plugin/plugin.json` → `version` |
...
| **test files** | **381** | `ls tests/test_*.py`; ~10427 tests |
...
**v2.152.0 — FREE CI speedup part 2: matrix-shard the Validate job + a detector FP-fix it surfaced (TRDD-V7K2QF8M; user: "can you find a better solution for the CI? free of course.")**
