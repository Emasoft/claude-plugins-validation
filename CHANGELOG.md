...
- **Enhanced**: `cpv-create-a-github-marketplace` — absorbs `cpv-setup-github-marketplace` workflow
- **Enhanced**: `cpv-publish-a-plugin-to-a-github-marketplace` — absorbs `cpv-publish-to-marketplace` workflow
