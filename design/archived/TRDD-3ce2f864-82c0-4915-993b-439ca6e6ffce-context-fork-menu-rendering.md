---
trdd-id: 3ce2f864
title: Use context fork for haiku menu rendering
column: superseded
...
- 2026-08-25T17:25:22+0200 — CLOSED as superseded by the CPV session (board drain;
  authority delegated by USER 2026-08-25). Superseded by the v2.161.0 de-fork —
  main-menu now runs inline, Stop-hook rendered (batch_ag).
