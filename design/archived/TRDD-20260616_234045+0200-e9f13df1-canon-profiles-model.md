...
- 2026-08-25T17:25:16+0200 — CLOSED as complete by the CPV session (board drain; authority delegated by USER 2026-08-25). SHIPPED core v2.128.0-v2.137.0 — cpv_pipeline_profile.py live; small janitor-dependent tail deliberately not carried forward (no demand since June); reopen as new TRDD if needed (batch_af)
