---
trdd-id: ebc745b5
title: TRDD-ebc745b5 — Claude Code v2.1.143 changelog catch-up
column: complete
...
- 2026-08-25T17:25:39+0200 — CLOSED as complete by the CPV session (board drain; authority delegated by USER 2026-08-25). SHIPPED commit d3d1a4bd — env vars in cpv_validation_common.py (batch_ak)
