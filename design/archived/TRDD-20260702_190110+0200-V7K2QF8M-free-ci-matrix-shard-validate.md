...
- 2026-08-25T17:25:22+0200 — CLOSED as cancelled by the CPV session (board drain;
  authority delegated by USER 2026-08-25). Approach measured and reverted in
  v2.152.1 (3m40s vs 3m41s baseline — perf goal unmet); retry declined, shard
  model rejected by measurement (batch_af).
