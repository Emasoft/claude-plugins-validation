...
title: Menu visibility and orchestrator latency fix (v2.89.4)
column: superseded
created: 2026-05-16T17:00:18+0200
updated: 2026-08-25T18:18:10+0200
superseded-by: menu-unification-v2.90.0
---
...
- 2026-08-25T18:18:10+0200 — SUPERSEDED (board drain, delegated authority). The
  v2.90.0 Menu Unification replaced the whole orchestrator-command-body-menu
  approach with the external `claude-menu-system` Stop-hook rendering model;
  none of the command files this card patched (`cpv-doctor.md`,
  `cpv-fix-validation.md`, `cpv-fix-marketplace-validation.md`,
  `cpv-cache-optimize.md`) exist any more. Verdict per
  `reports/board-triage/20260825_140706+0200-batch_ai.md` — this card was
  triaged SUPERSEDED in that batch but was dropped from the dispositions list;
  closed here during closure verification.
