---
trdd-id: 82e836dc
title: TRDD-82e836dc — Agent Model-Tier Policy Refactor
column: superseded
...
- 2026-08-25T17:25:27+0200 — CLOSED as superseded by the CPV session (board drain; authority delegated by USER 2026-08-25). model-tier policy shipped then deliberately reversed — CA-04 now recommends NO model pins; zero agents carry model: today (batch_ah)
