...
updated: 2026-09-02T12:05:00+0200
...
- NEXT ACTION: `uv run python scripts/publish.py --minor` (v5.16.0), then close #223/#224 with a fix comment naming the release, then move this card to `complete`.
